...
const Item = ({ profile, selected, onSelect, onRun, onStop, onSetting, settings, checkedColumns }: ItemProps) => {
  ...
  return (
    <div
      className="flex flex-col gap-2 p-2 border-2 border-gray-200 rounded-md cursor-pointer hover:border-primary transition-all duration-300 select-none shadow-md"
